...
FOUT=ROOT.TFile("%s/presentation_plots.root"%OUTDIR,"RECREATE")
#sys.exit()
#! ***
...
#! *** Now fill FIN/T[dtyp][rctn] ***
#! Can use $D2PIDIR_EXP(SIM)_E16/data_pcorr_011116 
...
#! For ER get d2piR_wpcorr and for SR d2piR_npcorr
