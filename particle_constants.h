...
namespace ParticleConstants {
    ...
    static const Float_t E1F_P = 5.499; //changed from 5.479 --> 5.499
    static const TLorentzVector E1F_4vE0(0,0,E1F_P,TMath::Sqrt(E1F_P*E1F_P+MASS_E*MASS_E));
	static const TLorentzVector E1F_4vP0(0,0,0,MASS_P);

    static const Float_t E16_P = 5.754; //changed from 5.700 post parkkj conversation on mtg 02-25-13
    static const TLorentzVector E16_4vE0(0,0,E16_P,TMath::Sqrt(E16_P*E16_P+MASS_E*MASS_E));
    static const TLorentzVector E16_4vP0(0,0,0,MASS_P);
}
