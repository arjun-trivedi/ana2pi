...
#! 1. lowQ2
#! SSBands,MM
h10_2_per_non_vst_SE_results.py e16 2.00 3.00 lowQ2_SSBands sim4:sim5:sim6:sim7:sim8:sim13:sim14 SSBands &
#wait
...
#! 2. highQ2
#! SSBands,MM
h10_2_per_non_vst_SE_results.py e16 3.00 5.00 highQ2_SSBands sim9:sim10:sim11:sim12:sim15 SSBands &
#wait
#! [08-12-17] MM removed as a part of re-obtain-obs-3
