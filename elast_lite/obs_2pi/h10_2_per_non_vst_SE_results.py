...
#! eff_scpd_atmod_ECfid_atmod: 4 combinations: {eff_scpd_atmod(:17:),ECfid_atmod(:18:)=ON/OFF, ON/OFF}
#! Remove :17:,:18: toggle SYSTEMATIC_EFFECT=="testdiffATEI"
BASIC_ADTNL_OPTS=':1:3:2:20:' #! ECin-on:zvtx-on:ECfid-ON:CC_cut_lse:

#! pfid: 2 combinations: {pfid_ep_on,pfid_ep_off}
...
elif SYSTEMATIC_EFFECT=="eff_scpd_atmod_ECfid_atmod": #! {eff_scpd_atmod,ECfid_atmod} #! testdiffATEI
...
elif SYSTEMATIC_EFFECT=="pfid": #! pfid #! testdiffATEI2
	ADTNL_OPTS_CODE_LIST=[':11:8:',        ':11:']
	ADTNL_OPTS_TAG_LIST =[':MM-EI:ei_pfid',':MM-EI:ep_pfid:'] 	
else:
	sys.exit("Please enter SYSTEMATIC_EFFECT as either SSBands or MM or eff_scpd_atmod_ECfid_atmod or pfid")
