...
for cutval in "${CUT_VALS[@]}";do
	...
	#! 1. lowQ2
	#! SSBands,MM
	h10_2_per_non_vst_SE_results.py e16 2.00 3.00 lowQ2_SSBands_SA_rel_err_cut_"$cutname" sim4:sim5:sim6:sim7:sim8:sim13:sim14 SSBands $cutval 032718 $SKIP_MAKE_D2PI $SKIP_DOBS_R2 $ACC_CUT &
	#wait
	...
	#! 2. highQ2
	#! SSBands,MM
	h10_2_per_non_vst_SE_results.py e16 3.00 5.00 highQ2_SSBands_SA_rel_err_cut_"$cutname" sim9:sim10:sim11:sim12:sim15 SSBands $cutval 032718 $SKIP_MAKE_D2PI $SKIP_DOBS_R2 $ACC_CUT&
	#wait
	#! [08-12-17] MM removed as a part of re-obtain-obs-3
